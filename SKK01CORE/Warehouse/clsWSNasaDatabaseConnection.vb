Public Class clsWSNasaDatabaseConnection
...
#Region "database connection"
    ...
    Public Function _pbNasaConnectDB01WSDirect(ByVal prmnTargetServer012 As Int16) As String
        Return _cm01NasaSQLConnection(prmnTargetServer012, "WS")
    End Function

    Protected Function _pbNasaConnectDB01WS(ByVal prmnTargetServer012 As Int16) As String
        Return _cm01NasaSQLConnection(prmnTargetServer012, "WS")
    End Function

    Protected Function _pbNasaConnectDB02WSLOG(ByVal prmnTargetServer012 As Int16) As String
        Return _cm01NasaSQLConnection(prmnTargetServer012, "WSLOG")
    End Function

    Protected Function _pbNasaConnectDB03TABLEMASTER(ByVal prmnTargetServer012 As Int16) As String
        Return _cm01NasaSQLConnection(prmnTargetServer012, "TABLEMASTER")
    End Function

    ' DATABASE WS24 FOR SOLD DATA
    Protected Function _pbNasaConnectDB04WS24(ByVal prmnTargetServer012 As Int16) As String
        Return _cm01NasaSQLConnection(prmnTargetServer012, "WS24")
    End Function
