Public Class clsWSNasaTemplateKey2
...
#End Region
    ...
    Private Function dtCreateKEY() As DataTable
        ...
        Dim fieldk06String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "k06String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldk06String)

        Dim fieldk07String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "k07String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldk07String)
    ...
    Public Sub dtAddNewKEY(ByVal prmk01String As String, ByVal prmk02String As String, ByVal prmk03String As String, ByVal prmk04String As String, ByVal prmk05String As String, ByVal prmk06String As String, ByVal prmk07String As String)
        ...
        oDataRow("k06String") = prmk06String
        oDataRow("k07String") = prmk07String
