Public Class clsWSNasaTemplateDataLargePlus
...
#End Region
    ...
    Public Property prop_dtsTABLELARGEPLUS As DataTable

    Private Function dtCreatesTABLELARGEPLUS() As DataTable
        ...
        Dim fieldf41String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f41String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf41String)

        Dim fieldf42String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f42String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf42String)

        Dim fieldf43String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f43String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf43String)

        Dim fieldf44String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f44String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf44String)

        Dim fieldf45String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f45String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf45String)

        Dim fieldf46String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f46String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf46String)

        Dim fieldf47String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f47String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf47String)

        Dim fieldf48String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f48String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf48String)

        Dim fieldf49String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f49String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf49String)

        Dim fieldf50String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f50String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf50String)

        Dim fieldf51String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f51String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf51String)

        Dim fieldf52String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f52String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf52String)

        Dim fieldf53String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f53String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf53String)

        Dim fieldf54String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f54String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf54String)

        Dim fieldf55String As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f55String", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf55String)
    ...
    Public Sub dtInitsTABLELARGEPLUS()
        prop_dtsTABLELARGEPLUS = Nothing
        prop_dtsTABLELARGEPLUS = dtCreatesTABLELARGEPLUS()
        prop_dtsTABLELARGEPLUS.Clear()
    End Sub

    Public Sub dtAddNewsTABLELARGEPLUS(
           ...
           ByVal prmf40String As String,
           ByVal prmf41String As String, ByVal prmf42String As String, ByVal prmf43String As String,
           ByVal prmf44String As String, ByVal prmf45String As String, ByVal prmf46String As String,
           ByVal prmf47String As String, ByVal prmf48String As String, ByVal prmf49String As String,
           ByVal prmf50String As String, ByVal prmf51String As String, ByVal prmf52String As String, ByVal prmf53String As String,
           ByVal prmf54String As String, ByVal prmf55String As String,
           ByVal prmf01TinyInt As Integer, ByVal prmf01SmallInt As Integer,
        ...
        Dim oDataRow As DataRow = prop_dtsTABLELARGEPLUS.NewRow()
        ...
        oDataRow("f41String") = prmf41String
        oDataRow("f42String") = prmf42String
        oDataRow("f43String") = prmf43String
        oDataRow("f44String") = prmf44String
        oDataRow("f45String") = prmf45String
        oDataRow("f46String") = prmf46String
        oDataRow("f47String") = prmf47String
        oDataRow("f48String") = prmf48String
        oDataRow("f49String") = prmf49String
        oDataRow("f50String") = prmf50String
        oDataRow("f51String") = prmf51String
        oDataRow("f52String") = prmf52String
        oDataRow("f53String") = prmf53String
        oDataRow("f54String") = prmf54String
        oDataRow("f55String") = prmf55String
        ...
        prop_dtsTABLELARGEPLUS.Rows.Add(oDataRow)
    End Sub
