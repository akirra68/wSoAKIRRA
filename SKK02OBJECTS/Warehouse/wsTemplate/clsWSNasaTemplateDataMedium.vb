'********** create .NET Controller : clsControllersTABLEMEDIUMPLUS.vb ****************

Public Class clsWSNasaTemplateDataMedium
    Implements IDisposable

    Public Property prop_dtsTABLEMEDIUM As DataTable

    Private Function dtCreatesTABLEMEDIUM() As DataTable
    ...
    Public Sub dtInitsTABLEMEDIUM()
        prop_dtsTABLEMEDIUM = Nothing
        prop_dtsTABLEMEDIUM = dtCreatesTABLEMEDIUM()
        prop_dtsTABLEMEDIUM.Clear()
    End Sub

    Public Sub dtAddNewsTABLEMEDIUM(
        ...
        Dim oDataRow As DataRow = prop_dtsTABLEMEDIUM.NewRow()
        ...
        prop_dtsTABLEMEDIUM.Rows.Add(oDataRow)
    End Sub
