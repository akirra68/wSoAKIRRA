Public Class clsWSNasaTemplateDataMediumPlus
...
#End Region
    ...
    Public Property prop_dtsTABLEMEDIUMPLUS As DataTable

    Private Function dtCreatesTABLEMEDIUMPLUS() As DataTable
    ...
    Public Sub dtInitsTABLEMEDIUMPLUSPLUS()
        prop_dtsTABLEMEDIUMPLUS = Nothing
        prop_dtsTABLEMEDIUMPLUS = dtCreatesTABLEMEDIUMPLUS()
        prop_dtsTABLEMEDIUMPLUS.Clear()
    End Sub

    Public Sub dtAddNewsTABLEMEDIUMPLUS(
                                   ...
                                   ByVal prmf21String As String, ByVal prmf22String As String,
                                   ...
                                   ByVal prmf02Int As Integer, ByVal prmf03Int As Integer,
                                   ...
                                   ByVal prmf04Date As Date, ByVal prmf05Date As Date,
        ...
        Dim oDataRow As DataRow = prop_dtsTABLEMEDIUMPLUS.NewRow()
        ...
        prop_dtsTABLEMEDIUMPLUS.Rows.Add(oDataRow)
    End Sub
