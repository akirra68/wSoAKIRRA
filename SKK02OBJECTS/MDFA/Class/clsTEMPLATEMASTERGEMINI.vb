'********** create .NET Controller : clsTEMPLATEMASTERGEMINI.vb ****************

'created : Kamis, 17 Agustus 2023 - 13:47 WIB
'dik Aya sakit gigi, pipi kanannya bengkak.
'bekas gigi geraham yg ditambal copot.
Public Class clsTEMPLATEMASTERGEMINI
    Implements IDisposable

    Public Property prop_dtMASTERGEMINI As DataTable

    Private Function dtCreateMASTERGEMINI() As DataTable
    ...
    Public Sub dtInitMASTERGEMINI()
        prop_dtMASTERGEMINI = Nothing
        prop_dtMASTERGEMINI = dtCreateMASTERGEMINI()
        prop_dtMASTERGEMINI.Clear()
    End Sub

    Public Sub dtAddNewMASTERGEMINI(ByVal prmk10String As String, ByVal prmk11String As String,
        ...
        Dim oDataRow As DataRow = prop_dtMASTERGEMINI.NewRow()
        ...
        prop_dtMASTERGEMINI.Rows.Add(oDataRow)
    End Sub
...
'********** end of .NET Controller : clsTEMPLATEMASTERGEMINI.vb ****************
