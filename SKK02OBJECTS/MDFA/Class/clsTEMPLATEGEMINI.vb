'********** create .NET Controller : clsTEMPLATEGEMINI.vb ****************

Public Class clsTEMPLATEGEMINI
     Implements IDisposable

Public Property prop_dtTABLEGEMINI As DataTable

Private Function dtCreateTABLEGEMINI As DataTable
     ...
     dtDataTable.Columns.Add(fieldf01Memo)
        ...
        Dim fieldf03Memo As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f03Memo", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf03Memo)

        Dim fieldf04Memo As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f04Memo", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf04Memo)

        Dim fieldf05Memo As DataColumn = New DataColumn() With {.DataType = Type.GetType("System.String"), .ColumnName = "f05Memo", .DefaultValue = ""}
        dtDataTable.Columns.Add(fieldf05Memo)
...
Public Sub dtInitTABLEGEMINI()
     prop_dtTABLEGEMINI = Nothing
     prop_dtTABLEGEMINI = dtCreateTABLEGEMINI()
     prop_dtTABLEGEMINI.Clear()
End Sub

    'ByVal prmf02Memo As Byte(),
    Public Sub dtAddNewTABLEGEMINI(ByVal prmk01String As String, ByVal prmk02Int As Integer, ByVal prmk03String As String, ByVal prmk04String As String, ByVal prmk05String As String,
                                   ...
                                   ByVal prmf01Memo As String, ByVal prmf03Memo As String, ByVal prmf04Memo As String, ByVal prmf05Memo As String,
        ...
        Dim oDataRow As DataRow = prop_dtTABLEGEMINI.NewRow()
        ...
        oDataRow("f03Memo") = prmf03Memo
        oDataRow("f04Memo") = prmf04Memo
        oDataRow("f05Memo") = prmf05Memo
        ...
        prop_dtTABLEGEMINI.Rows.Add(oDataRow)
    End Sub
...
'********** end of .NET Controller : clsTEMPLATEGEMINI.vb ****************
