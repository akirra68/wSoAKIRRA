...
#End Region
    ...
    Public Property prop_dtKEYGEMINI As DataTable

    Private Function dtCreateKEYGEMINI() As DataTable
    ...
    Public Sub dtInitKEYGEMINI()
        prop_dtKEYGEMINI = Nothing
        prop_dtKEYGEMINI = dtCreateKEYGEMINI()
        prop_dtKEYGEMINI.Clear()
    End Sub

    Public Sub dtAddNewKEYGEMINI(ByVal prmk01String As String, ByVal prmk02String As String, ByVal prmk03String As String, ByVal prmk04String As String, ByVal prmk05String As String)

        Dim oDataRow As DataRow = prop_dtKEYGEMINI.NewRow()
        ...
        prop_dtKEYGEMINI.Rows.Add(oDataRow)
    End Sub
