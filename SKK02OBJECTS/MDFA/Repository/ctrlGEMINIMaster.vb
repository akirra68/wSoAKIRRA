...
#End Region
    ...
    Public Sub _03BindingAwalDataSource2Field()
        ...
        Dim ctrlGEMINIMaster1View As GridView = New GridView()
        With ctrlGEMINIMaster1View
            .Columns.Clear()
        ...
        ctrlGEMINIMaster1View.Columns(pcfieldValueMember).Width = 75
        ctrlGEMINIMaster1View.Columns(pcfieldDisplayMember).Width = 500
        ...
        With Properties
            ...
            .NullText = ""
            .PopupView = ctrlGEMINIMaster1View
        End With
    ...
    Public Sub _03BindingAwalDataSource3Field(ByVal prmNamaField01 As String, ByVal prmCaptionField01 As String,
        ...
        objGridView.Columns(pcfieldValueMember).Width = 150
        objGridView.Columns(pcfieldDisplayMember).Width = 150
        objGridView.Columns(pcfieldDisplayMember01).Width = 300

        If prmCaptionField03 = "HargaEmas" Then
            With objGridView.Columns(pcfieldDisplayMember01).DisplayFormat
    ...
    Friend WithEvents ctrlGEMINIMaster1View As GridView

    Public Sub New()
        ctrlGEMINIMaster1View = New GridView()
    End Sub
    ...
    Public Sub _03BindingAwalDataSource4Field(ByVal prmNamaField01 As String, ByVal prmCaptionField01 As String,
        ...
        CType(Me.Properties, ComponentModel.ISupportInitialize).BeginInit()
        CType(ctrlGEMINIMaster1View, ComponentModel.ISupportInitialize).BeginInit()
        SuspendLayout()

        ctrlGEMINIMaster1View.Columns(pcfieldValueMember).Width = 150
        ctrlGEMINIMaster1View.Columns(pcfieldDisplayMember).Width = 150
        ctrlGEMINIMaster1View.Columns(pcfieldDisplayMember01).Width = 300
        ctrlGEMINIMaster1View.Columns(pcfieldDisplayMember02).Width = 150

        If prmCaptionField04 = "HargaEmas" Then
            With ctrlGEMINIMaster1View.Columns(pcfieldDisplayMember02).DisplayFormat
                .FormatType = DevExpress.Utils.FormatType.Numeric
                .FormatString = "{0:N0}"
            End With
        End If
        ...
        CType(Me.Properties, ComponentModel.ISupportInitialize).EndInit()
    ...
    Public Sub _03BindingAwalDataSource7Field(ByVal prmNamaField01 As String, ByVal prmCaptionField01 As String,
        ...
        objGridView.Columns(pcfieldDisplayMember).Width = 150
        objGridView.Columns(pcfieldDisplayMember01).Width = 300
        objGridView.Columns(pcfieldDisplayMember02).Width = 150
        objGridView.Columns(pcfieldDisplayMember03).Width = 150
        objGridView.Columns(pcfieldDisplayMember04).Width = 150
        objGridView.Columns(pcfieldDisplayMember05).Width = 300
    ...
    Public Function _05GetRecordTerpilih() As DataRow()
        ...
        If Not String.IsNullOrEmpty(Me.EditValue) Then
            pdDataRow = pdtCopy.Select(_07prop_cGEMINIKeyKolomFilterUntSelect & " = '" & Me.EditValue & "'")
        End If
