...
using System.IO;
using SHAN04SECURITY.Shared;
using SHAN04SECURITY.Extensions;
using SHAN04SECURITY.Internal;
using SHAN04SECURITY.Extensions.Internal;
...
namespace SHAN04SECURITY
{
    public class EncryptProvider
    {
        ...
        */
        ...
        // Hash file fisik (lama, tetap boleh dipakai)
        ...
        // Hash data di dalam Excel (baru, untuk cegah duplikat walau Save As)
        public static string Sha256ExcelData(string filePath)
        {
                ...
                foreach (var ws in workbook.Worksheets)
                {
                    foreach (var row in ws.RangeUsed().RowsUsed())
                    {
                        foreach (var cell in row.CellsUsed())
                        {
                            ...
                            sb.Append("|"); // pemisah antar cell
                        }
                        sb.AppendLine(); // pemisah antar row
                    }
                }
            }
